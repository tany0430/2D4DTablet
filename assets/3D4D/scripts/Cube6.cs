...
public class Cube6 : MonoBehaviour {
	...
	void Start () {
		...
		Cube6MH = GameObject.Find ("Cube6Mesh");
	...
	void Update () {
		...
		Cube6MH.gameObject.transform.eulerAngles = new Vector3(posX, posX, posX) * 90.0f;
		...
		cuberender.material.color = new Color (1, 1, 0.8f, Alpha);
