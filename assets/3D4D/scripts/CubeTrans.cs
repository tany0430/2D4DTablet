...
public class CubeTrans : MonoBehaviour {
	...
	private GameObject CubeTransMH; 
	...
	void Start () {
		...
		CubeTransMH = GameObject.Find ("CubeTransMesh");
	...
	void Update () {
		...
		CubeTransMH.gameObject.transform.eulerAngles = new Vector3(posX, posX, posX) * 90.0f;
		...
		cuberender.material.color = new Color (0.3f, 0.3f, 0.3f, Alpha);
