...
public class Cube5 : MonoBehaviour {
	...
	void Start () {
		...
		Cube5MH = GameObject.Find ("Cube5Mesh");
	...
	void Update () {
		...
		Cube5MH.gameObject.transform.eulerAngles = new Vector3(posX, posX, posX) * 90.0f;
		...
		cuberender.material.color = new Color (0.9f, 1, 1, Alpha);
	...
	public void Cb3D(float posi)
	{
...

		{
			...
			vec(-0.5f - posi ,  0.5f +1  , -0.5f - posi),
			vec( 0.5f + posi,  0.5f+1 , -0.5f - posi),
			vec( 0.5f, -0.5f +1, -0.5f ),
			vec(-0.5f , -0.5f +1, -0.5f ),
