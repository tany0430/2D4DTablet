...
public class Cube3 : MonoBehaviour {
	...
	void Start () {
		...
		Cube3MH = GameObject.Find ("Cube3Mesh");
	...
	void Update () {
		...
		Cube3MH.gameObject.transform.eulerAngles = new Vector3(posX, posX, posX) * 90.0f;
		...
		cuberender.material.color = new Color (0.9f, 1, 0.9f, Alpha);
