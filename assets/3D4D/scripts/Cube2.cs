...
public class Cube2 : MonoBehaviour {
	...
	void Start () {
		...
		Cube2MH = GameObject.Find ("Cube0Mesh");
	...
	void Update () {
		...
		Cube2MH.gameObject.transform.eulerAngles = new Vector3(posX, posX, posX) * 90.0f;
		...
		cuberender.material.color = new Color (0.9f, 0.9f, 1f, Alpha);
